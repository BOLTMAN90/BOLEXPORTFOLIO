  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-primary/40 bg-transparent hover:bg-primary/10 hover:border-primary",
        ghost: "hover:bg-accent/10 hover:text-accent-foreground",
        glow: "relative overflow-hidden border border-primary/50 bg-primary/20 text-foreground shadow-[0_0_24px_-4px_rgba(124,58,237,0.5)] hover:shadow-[0_0_32px_-4px_rgba(0,229,255,0.4)] hover:border-[#00E5FF]/50",
