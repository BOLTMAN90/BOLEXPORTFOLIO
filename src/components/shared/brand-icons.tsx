...
export function FiverrIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="#1DBF73" aria-hidden>
...
export function UpworkIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="#6FDA44" aria-hidden>
...
export function SocialLinkIcon({
  ...
  link: Pick<SocialLink, "icon" | "brand">;
  className?: string;
}) {
  switch (link.brand) {
    case "x":
